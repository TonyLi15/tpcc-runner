...
class Operation {
 public:
  ...
  Version *pending_ = nullptr;  // created in the initialization phase
...
/*
One TPC-C NP transaction as the deterministic protocols see it. Generation is
separate from construction because the order-id assigner is shared across the
whole run.
*/
class OperationSet {
 public:
